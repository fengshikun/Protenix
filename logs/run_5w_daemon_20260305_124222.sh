...
conda run --no-capture-output -n protenix311 \
  ...
  runner/train.py \
    ...
    --run_name "DDP8-contrast-drugclipmask-v027-50k-20260305_124222" \
    --base_dir ./output \
    --batch_size 8 \
    --data.batch_size 8 \
    --data.num_dl_workers 0 \
    --model.N_cycle 1 \
    --esm.local_model_path "/home/dataset-assist-0/tmp/zsl/zsl/Protenix/weight/" \
    --unimol.dict_path "/home/dataset-assist-0/tmp/zsl/zsl/Protenix/protenix/model/unimol/data" \
    --unimol.pretrained_path "/home/dataset-assist-0/tmp/zsl/zsl/Protenix/weight/mol_pre_no_h_220816.pt" \
